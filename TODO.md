...
### TODO Add exception hierarchy
I think there should be a root exception, perhaps in `cytraco.bootstrap`, e.g. `CytracoError`, and that there should be a separate error per protocol e.g. `PowerMeterError`.
